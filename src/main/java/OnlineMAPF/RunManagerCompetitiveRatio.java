...
public class RunManagerCompetitiveRatio extends A_RunManager {
...
//        addExperimentstTestFreespaceDirection();
        addExperimentstCompetitiveRatio1();
        addExperimentstCompetitiveRatio2();
    }
...
//                            InstanceReport.StandardFields.solution}
    ...
    private void addExperimentstCompetitiveRatio1() {
        /*  =   Set Path   =*/
        String path = IO_Manager.buildPath( new String[]{   IO_Manager.resources_Directory,
                "Instances\\\\Online\\\\MovingAI_Instances\\\\CompetitiveRatio\\\\experiment1"});
        ...
        /*  =   Add new experiment   =  */
        OnlineExperiment experiment = new CRExperiment("Competitive Ratio 1", instanceManager, null);
        experiment.keepSolutionInReport = true;
        this.experiments.add(experiment);
    }

    private void addExperimentstCompetitiveRatio2() {
        /*  =   Set Path   =*/
        String path = IO_Manager.buildPath( new String[]{   IO_Manager.resources_Directory,
                "Instances\\\\Online\\\\MovingAI_Instances\\\\CompetitiveRatio\\\\experiment2"});
        ...
        /*  =   Add new experiment   =  */
        OnlineExperiment experiment = new CRExperiment("Competitive Ratio 2", instanceManager, null);
        experiment.keepSolutionInReport = true;
        this.experiments.add(experiment);
    }
