...
import OnlineMAPF.Solvers.ReplanSingleGrouped;
import OnlineMAPF.Solvers.ThroughputPriority;
...
public class RunManagerOnlineThroughput extends A_RunManager {
    ...
    public void runAllExperiments() {
        try {
            S_Metrics.setHeader(new String[]{
                    ...
                    InstanceReport.StandardFields.capacityBreached,
                    InstanceReport.StandardFields.throughput,
